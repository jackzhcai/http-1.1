...
最通用形式的请求ＵＲI用于标识在原服务器或网关上的资源.这种情况下，绝对ＵＲＬ路径必须作为请求ＵＲＬ传送（看3.２.1节，绝对路径），ＵＲＩ局域网地址(authority)(必须输入主机报头域.例如，希望直接得到原服务器顶层资源的客户机将在"ｗｗｗ.ｗ3.ｏｒｇ"主机的端口８0建立ＴＣＰ连接发送以下行：
```　　
...
3. 假如由规定1或规定２定义的主机是无效的主机，则应答当是一个400出错信息
